...
// ----- Bilateral_filter_example -----

Bilateral_filter_example::Bilateral_filter_example(Render_context& rnd_ctx)
	: Example(rnd_ctx)
{
...
void Bilateral_filter_example::init_pipeline_state()
{
...
void Bilateral_filter_example::init_shaders()
{
	auto compute_desc = cg::rnd::dx11::load_hlsl_compute_desc("../../data/learn_dx11/image_processing/bilateral_filter.compute.hlsl");
...
void Bilateral_filter_example::init_textures()
{
...
void Bilateral_filter_example::perform_filtering()
{
...
void Bilateral_filter_example::setup_pipeline_state()
{
...
void Bilateral_filter_example::update_pvm_matrix(float aspect_ratio)
{
