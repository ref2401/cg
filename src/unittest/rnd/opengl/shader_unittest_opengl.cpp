...
public:
	...
	TEST_METHOD(attribs)
	{
		...
		Assert::IsFalse(has_tangent_space(attribs0));
		...
		Assert::IsFalse(has_tangent_space(attribs_p));
		...
		Assert::IsFalse(has_tangent_space(attribs_n));
		...
		Assert::IsFalse(has_tangent_space(attribs_tc));
		...
		Assert::IsTrue(has_tangent_space(attribs_th));
		...
		Assert::IsTrue(has_tangent_space(attribs_all));
	}
};
