...
public:
	...
	{
		assert(_vao_id != cg::rnd::opengl::Blank::vao_id);
	}
...
struct Vertex_attrib_layout {
	...
	GLint position_location = cg::rnd::opengl::Blank::vertex_attrib_location;
	GLint normal_location = cg::rnd::opengl::Blank::vertex_attrib_location;
	GLint tex_coord_location = cg::rnd::opengl::Blank::vertex_attrib_location;
	GLint tangent_h_location = cg::rnd::opengl::Blank::vertex_attrib_location;
};
